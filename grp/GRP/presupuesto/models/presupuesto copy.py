...
class Documento(models.Model):
    ...
    clase_documento = fields.Many2one(comodel_name='presupuesto.clase_documento', string=u'Clase documento', required=True,track_visibility='onchange')
    version = fields.Many2one(comodel_name='presupuesto.version', string=u'Versión',default='0', required=True,track_visibility='onchange')
    ...
    referencia_compra = fields.Many2one(comodel_name='purchase.order', string='Referencia', readonly=True)
    referencia_factura = fields.Many2one(comodel_name='account.invoice', string='Referencia', readonly=True)
    referencia_pago = fields.Many2one(comodel_name='account.payment', string='Referencia', readonly=True)
    ...
    clase_documento_ajuste = fields.Many2one(comodel_name='presupuesto.clase_documento', string=u'Clase documento', required=True)
...
class DetalleDocumento(models.Model):
    ...
    documento_id = fields.Many2one(comodel_name='presupuesto.documento', string="Documento", required=True)

    fondo_economico = fields.Many2one(comodel_name='presupuesto.fondo_economico', string='Fondo', required=True, readonly=1,  default=get_fondo_economico)
    posicion_presupuestaria = fields.Many2one(comodel_name='presupuesto.partida_presupuestal', string='Posición presupuestaria', required=True, domain="[('control_contable_presupuestalc', '=', 0), ('capitulo', '>=', 1), ('capitulo', '<=', 5), ('concepto', '>', 0)]")
    centro_gestor = fields.Many2one(comodel_name='presupuesto.centro_gestor', string='Centro gestor', required=True, readonly=1,  default=get_centro_gestor)
    area_funcional = fields.Many2one(comodel_name='presupuesto.area_funcional', string='Área funcional', required=True)
    importe = fields.Float(string='Importe', digits=(15, 2), required=True, default=0)
    control_presupuesto_id = fields.Many2one(comodel_name='presupuesto.control_presupuesto',string='Control presupuesto')
    ...
    control_presupuesto_nomina_id = fields.Many2one(comodel_name='nomina.nomina.control', string='Control presupuesto nomina')
...
class ControlPresupuesto(models.Model):
    ...
    version = fields.Many2one(comodel_name='presupuesto.version', string='Version', required=True)
    fondo_economico = fields.Many2one(comodel_name='presupuesto.fondo_economico', string='Fondo')
    posicion_presupuestaria = fields.Many2one(comodel_name='presupuesto.partida_presupuestal', string='Posición presupuestaria')
    centro_gestor = fields.Many2one(comodel_name='presupuesto.centro_gestor', string='Centro gestor')
    area_funcional = fields.Many2one(comodel_name='presupuesto.area_funcional', string='Área funcional')
        ...
        for item in self:
            ...
            for detalle in item.detalle_transferencia_ids:
                ...
                if detalle.tipo_reclasificacion == 'REDUCCION':
                    ...
                    co_egreso_r[2]['account_id'] = co_r.cta_orden_modificado_ingreso.id
                    co_ingreso_r[2]['account_id'] = co_r.cta_orden_modificado_egreso.id
...
class DetalleTransferencia(models.Model):
    ...
    transferencia_id = fields.Many2one(comodel_name='presupuesto.transferencia', string='Transferencia')
    tipo_reclasificacion = fields.Selection([('REDUCCION', 'Reducción'),('AMPLIACION', 'Ampliación')], string="Tipo", required=True)
    de_posicion_presupuestaria = fields.Many2one(comodel_name='presupuesto.partida_presupuestal', string='Posición presupuestaria', domain="[('control_contable_presupuestalc', '=', 0), ('capitulo', '>=', 1), ('capitulo', '<=', 5), ('concepto', '>', 0)]")
    de_centro_gestor = fields.Many2one(comodel_name='presupuesto.centro_gestor', string='Centro gestor', readonly=1,  default=get_centro_gestor_transferencia)
    de_area_funcional = fields.Many2one(comodel_name='presupuesto.area_funcional', string='Área funcional')
    de_importe = fields.Float(string='Importe', digits=(15, 2), default=0)
    para_posicion_presupuestaria = fields.Many2one(comodel_name='presupuesto.partida_presupuestal', string='Posición presupuestaria', domain="[('control_contable_presupuestalc', '=', 0), ('capitulo', '>=', 1), ('capitulo', '<=', 5), ('concepto', '>', 0)]")
    para_centro_gestor = fields.Many2one(comodel_name='presupuesto.centro_gestor', string='Centro gestor', readonly=1,  default=get_centro_gestor_transferencia)
    para_area_funcional = fields.Many2one(comodel_name='presupuesto.area_funcional', string='Área funcional')
    para_importe = fields.Float(string='Importe', digits=(15, 2), default=0)
    doc_reduccion = fields.Many2one(comodel_name='presupuesto.documento', readonly=1, index=True,domain=[('clase_documento.tipo_documento', '=', 'RECLASIFICACION'),('clase_documento.signo', '=', '-')])
    doc_ampliacion = fields.Many2one(comodel_name='presupuesto.documento', readonly=1, index=True,domain=[('clase_documento.tipo_documento', '=', 'RECLASIFICACION'),('clase_documento.signo', '=', '+')])
...
class PresupuestoMinistracion(models.Model):
    ...
    periodo = fields.Selection(catalogos.PERIODO_SELECT, required=True)
    centro_gestor = fields.Many2one(comodel_name='presupuesto.centro_gestor', string='Centro gestor')
    area_funcional_m = fields.Char(default='121004', string='Area Funcional', readonly=True)
...
class PresupuestoCanModMomentos(models.Model):
    ...
    purchase_origen=fields.Many2one(comodel_name='purchase.order', string='Compra',required=True)
    documento_origen=fields.Many2one(comodel_name='presupuesto.documento', string='Documento presupuestal',required=True)
    asiento_origen=fields.Many2one(comodel_name='account.move', string='Asiento',required=True)
    ...
    partidas_doc = fields.Many2one(comodel_name='presupuesto.detalle_documento',string='Partidas documento')
